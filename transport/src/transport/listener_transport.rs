...
use crate::{error::{JoinThreadError, SpawnThreadError}, ParaStream, ReceiveBufferShare};
...
{
    type ListenerError: Send + Error + From<Self::ConnectError> + From<Self::StreamError> + From<BufferError> + From<JoinThreadError>;
